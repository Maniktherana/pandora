...
extern "C" {
    ...
    pub fn ghostty_surface_write_buffer(surface: ghostty_surface_t, data: *const u8, len: usize);
    pub fn ghostty_surface_process_exit(surface: ghostty_surface_t, exit_code: u32, duration: u64);
