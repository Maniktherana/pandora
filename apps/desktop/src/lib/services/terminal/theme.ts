...
import type { TerminalThemeColors, WorkspaceTheme } from "@/lib/shared/theme";
import { defaultTheme } from "@/lib/shared/theme";

/**
 * Ghostty-format theme config using the same key=value format as
 * ~/.config/ghostty/config and Ghostty theme files.
 */
