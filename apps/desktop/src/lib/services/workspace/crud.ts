import type { WorkspaceKind, WorkspaceRecord } from "@/lib/shared/shared.types";
import {
  applyAppState,
...
import { DesktopStateLoadError, WorkspaceSelectionError } from "@/lib/services/errors";
import {
  loadAppState,
  saveSelection,
...
import type { createTerminalStartupService } from "@/lib/services/terminal/startup";
