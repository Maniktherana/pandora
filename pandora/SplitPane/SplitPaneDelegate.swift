...
public protocol SplitPaneDelegate: AnyObject {
    ...
    func splitTabBar(_ controller: SplitPaneController, shouldCreateTab tab: Tab, inPane pane: PaneID) -> Bool

    /// Called when a tab is about to be closed.
    /// Return `false` to prevent closing (e.g., prompt to save unsaved changes).
    func splitTabBar(_ controller: SplitPaneController, shouldCloseTab tab: Tab, inPane pane: PaneID) -> Bool

    // MARK: - Tab Lifecycle (Notifications)

    /// Called after a tab has been created.
    func splitTabBar(_ controller: SplitPaneController, didCreateTab tab: Tab, inPane pane: PaneID)
    ...
    func splitTabBar(_ controller: SplitPaneController, shouldClosePane pane: PaneID) -> Bool
    ...
    func splitTabBar(_ controller: SplitPaneController, shouldNotifyDuringDrag: Bool) -> Bool
}

// MARK: - Default Implementations (all methods optional)

public extension SplitPaneDelegate {
    func splitTabBar(_ controller: SplitPaneController, shouldCreateTab tab: Tab, inPane pane: PaneID) -> Bool { true }
    func splitTabBar(_ controller: SplitPaneController, shouldCloseTab tab: Tab, inPane pane: PaneID) -> Bool { true }
    func splitTabBar(_ controller: SplitPaneController, didCreateTab tab: Tab, inPane pane: PaneID) {}
    func splitTabBar(_ controller: SplitPaneController, didCloseTab tabId: TabID, fromPane pane: PaneID) {}
    func splitTabBar(_ controller: SplitPaneController, didSelectTab tab: Tab, inPane pane: PaneID) {}
    func splitTabBar(_ controller: SplitPaneController, didMoveTab tab: Tab, fromPane source: PaneID, toPane destination: PaneID) {}
    func splitTabBar(_ controller: SplitPaneController, shouldSplitPane pane: PaneID, orientation: SplitOrientation) -> Bool { true }
    func splitTabBar(_ controller: SplitPaneController, shouldClosePane pane: PaneID) -> Bool { true }
    func splitTabBar(_ controller: SplitPaneController, didSplitPane originalPane: PaneID, newPane: PaneID, orientation: SplitOrientation) {}
    func splitTabBar(_ controller: SplitPaneController, didClosePane paneId: PaneID) {}
    func splitTabBar(_ controller: SplitPaneController, didFocusPane pane: PaneID) {}
    func splitTabBar(_ controller: SplitPaneController, didChangeGeometry snapshot: LayoutSnapshot) {}
    func splitTabBar(_ controller: SplitPaneController, shouldNotifyDuringDrag: Bool) -> Bool { false }
}
