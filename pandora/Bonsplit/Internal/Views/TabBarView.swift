...
struct TabBarView: View {
    ...
    var body: some View {
        ...
        .onChange(of: splitViewController.draggingTab?.id) { _, newValue in
            if newValue == nil {
                dropTargetIndex = nil
            }
        }
    ...
    private func tabItem(for tab: TabItem, at index: Int) -> some View {
        ...
        .overlay(alignment: .leading) {
            if splitViewController.draggingTab != nil && dropTargetIndex == index {
                dropIndicator
            }
        }
    }
    ...
    private var dropZoneAtEnd: some View {
        Rectangle()
            ...
            .overlay(alignment: .leading) {
                if splitViewController.draggingTab != nil && dropTargetIndex == pane.tabs.count {
                    dropIndicator
                }
            }
    }
